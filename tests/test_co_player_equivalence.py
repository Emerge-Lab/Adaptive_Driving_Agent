...
Loads the actual `experiments/puffer_drive_b6big5j1.pt` co-player Transformer
...
def main():
    checkpoint = os.environ.get("CO_PLAYER_CKPT", "experiments/puffer_drive_b6big5j1.pt")
