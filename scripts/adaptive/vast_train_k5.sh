...
GPU=$1; SEED=$2; MAX_MINIBATCH_SIZE=${3:-10050}; TOTAL_TIMESTEPS=${4:-3000000000}; EVAL_INTERVAL=${5:-10}; VEC=${6:-16}  # must divide 50*HORIZON=50250: {25125,16750,10050,...}
...
K_SCENARIOS=5
SCENARIO_LENGTH=201
HORIZON=$((K_SCENARIOS * SCENARIO_LENGTH))   # 1005

TAG="k5_standard_recipe_e010"

echo "[vast_k5] gpu=$GPU seed=$SEED horizon=$HORIZON max_minibatch=$MAX_MINIBATCH_SIZE steps=$TOTAL_TIMESTEPS tag=$TAG"
