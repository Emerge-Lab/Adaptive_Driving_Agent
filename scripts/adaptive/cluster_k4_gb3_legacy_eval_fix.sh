...
#SBATCH --array=0-0
#
# k=4 trials gb=3 with legacy-eval fix. Same cell as k=2 lefix:
# LR=3e-3, ent=0.005, seed=42, partner p010, lane=0.05.
# Tests whether the fix unlocks training at k=4 (4 trials, horizon=804).
#
# Submit: sbatch scripts/adaptive/cluster_k4_gb3_legacy_eval_fix.sh
...
MAX_MINIBATCH_SIZE=$((50 * HORIZON))         # 40200

TAG="ada_k4_gb3_legacy_eval_fix"

echo "[k4_lefix] seed=$SEED  lr=$LR  ent_coef=$ENT_COEF  horizon=$HORIZON  tag=$TAG"
