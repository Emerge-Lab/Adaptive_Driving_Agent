...
TAG="demo_trial0_h128_k4_e010"

echo "[demo_h128] task=$SLURM_ARRAY_TASK_ID  hidden=$HIDDEN_SIZE  seed=$SEED  partner=$PARTNER_ID  e_ub=$ENTROPY_UB  k=$K_SCENARIOS  horizon=$HORIZON  demo_trial_0=True  tag=$TAG"
