...
CONFIGS=(42 43 44)
SEED="${CONFIGS[$SLURM_ARRAY_TASK_ID]}"
...
echo "[e0001_k4] task=$SLURM_ARRAY_TASK_ID  seed=$SEED  partner=$PARTNER_ID  e_ub=$ENTROPY_UB  k=$K_SCENARIOS  horizon=$HORIZON  tag=$TAG"
